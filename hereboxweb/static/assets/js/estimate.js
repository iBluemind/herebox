...
var regularItemNumber = "";
var irregularItemNumber = "";
var disposableNumber = "";
var bindingProduct0Number = "";
var bindingProduct1Number = "";
var bindingProduct2Number = "";
var bindingProduct3Number = "";
...
$(document).ready(function() {
    ...
    regularItemNumber = regularItem.find('.number');
    ...
    irregularItemNumber = irregularItem.find('.number');
    ...
    disposableNumber = disposable.find('.number');
    ...
    bindingProduct0Number = bindingProduct0.find('.number');
    ...
    bindingProduct1Number = bindingProduct1.find('.number');
    ...
    bindingProduct2Number = bindingProduct2.find('.number');
    ...
    bindingProduct3Number = bindingProduct3.find('.number');
